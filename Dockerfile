...
ARG PHP_URL="https://secure.php.net/get/php-7.4.15.tar.xz/from/this/mirror"
ARG PHP_ASC_URL="https://secure.php.net/get/php-7.4.15.tar.xz.asc/from/this/mirror"
ARG PHP_SHA256="9b859c65f0cf7b3eff9d4a28cfab719fb3d36a1db3c20d874a79b5ec44d43cb8"
ARG PHP_MD5=""
...
# 使用pecl安装redis扩展
    ...
    && cd /usr/src && pecl download swoole-4.6.2 \
    && tar xzf /usr/src/swoole-4.6.2.tgz -C /usr/src \
    && cd /usr/src/swoole-4.6.2 \
